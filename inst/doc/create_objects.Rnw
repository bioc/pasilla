...
The SAM alignments are also available in \url{www.embl.de/~reyes/Graveley/bam}.
...
\begin{lstlisting}
wget \
ftp://ftp.ensembl.org/pub/release-62/gtf/drosophila_melanogaster/Drosophila_melanogaster.BDGP5.25.62.gtf.gz
...
sort -k 1,1 -k2,2n treated2.bam > treated2_sorted.bam
